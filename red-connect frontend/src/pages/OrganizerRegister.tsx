...
const OrganizerRegister = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.contact_person || !formData.email || !formData.password) {
    ...
    try {
      const payload = {
        ...
        organization_name: formData.contact_person, // Use contact person as org name
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="street_address" className="text-gray-700 font-medium">
                  Address Line 2
                </Label>
                <Input
                  id="street_address"
