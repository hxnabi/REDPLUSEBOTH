...
# Blood Bank Revenue Schemas
class BloodBankRevenueBase(BaseModel):
    blood_bank_id: int
...
class BloodBankRevenueCreate(BloodBankRevenueBase):
    pass

class BloodBankRevenueResponse(BloodBankRevenueBase):
    id: int
    created_at: datetime
